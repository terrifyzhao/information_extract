import json
from baseline.model_baseline import model
import os
import numpy as np
...
subject_model.load_weights(path+'/out/subject_model.weights')
object_model.load_weights(path+'/out/object_model.weights')
